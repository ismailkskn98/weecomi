...
function LinkedInIcon({ className = iconClassName }) {
  return (
...
function InstagramIcon({ className = iconClassName }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
...
function XIcon({ className = iconClassName }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
...
function YouTubeIcon({ className = iconClassName }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>

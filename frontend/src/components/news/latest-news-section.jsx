  ...
  return (
    <ScrollReveal itemSelector="[data-news-item]" className="section-y bg-white">
      <div className="gridContainer">
        <div data-news-item className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <SectionHeader align="left" title={t("title")} subtitle={t("subtitle")} className="md:max-w-xl [&_h2]:font-heading [&_h2]:leading-display" />

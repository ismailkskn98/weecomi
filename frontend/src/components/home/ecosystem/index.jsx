...
export default async function Ecosystem() {
  ...
  return (
    <section id="ecosystem" className="relative section-y">
      <div className="relative z-10 gridContainer min-w-0">
        ...
        <ScrollReveal as="div" itemSelector="[data-eco-card]" className="mt-10 grid min-w-0 gap-3 md:mt-12 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-[auto_auto] lg:gap-4" y={36} start="top 80%" stagger={0.12} duration={0.55}>
          {alisveriskapida ? (
          ...
          {weecoins ? (
            ...
            <WeecoinsCard
              title={t("weecoinsCard.title")}
              description={t("weecoinsCard.description")}
              ribbonBadge={t("weecoinsCard.ribbonBadge")}
              ribbonItems={t.raw("weecoinsCard.ribbonItems")}
            />
            </div>
          ) : null}

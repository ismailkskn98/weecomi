  ...
  return (
    <div className="relative h-full min-h-72 w-full overflow-hidden md:min-h-full">
      ...
      <div
        ...
        aria-hidden
        style={{ backgroundImage: "linear-gradient(rgba(13,13,13,0.35) 1px, transparent 1px), linear-gradient(90deg, rgba(13,13,13,0.35) 1px, transparent 1px)", backgroundSize: "44px 44px" }}
      />
      ...
      <div className="absolute left-[8%] top-[18%] z-10 w-[23rem] sm:left-[10%] sm:top-[16%] sm:w-[29rem] md:left-[14%] md:top-[10%] md:w-[40rem] lg:left-[14%] lg:top-[8%] lg:w-[48rem] xl:left-[12%] xl:w-[52rem]">
        <div className="overflow-hidden rounded-[1.2rem] border border-black/10 bg-white shadow-[0_28px_80px_rgba(13,13,13,0.16)]">
          <Image src="/images/weesale.jpg" alt="WeeSale marketplace interface" width={1024} height={750} className="h-auto w-full object-cover object-top" sizes="(max-width: 768px) 92vw, 52rem" />
        </div>
      </div>
    </div>
  );

  ...
  return (
    <section className="pt-14 md:pt-20">
      <div className="gridContainer">
        <ScrollReveal itemSelector="[data-about-stat-heading]" start="top bottom" y={20} as="div" className="mx-auto mb-10 max-w-2xl text-center md:mb-12">
        ...
        <div className="grid gap-10 sm:grid-cols-3 sm:gap-8">
          {STATS.map((stat) => (
            <StatItem key={stat.key} value={stat.value} suffix={stat.suffix} label={t(`stats.${stat.key}.label`)} text={t(`stats.${stat.key}.text`)} />
          ))}
        </div>
      </div>
    </section>

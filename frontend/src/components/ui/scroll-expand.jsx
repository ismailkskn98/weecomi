...
const ScrollExpand = ({
  ...
  useEffect(() => {
    ...
    const measure = () => {
      ...
      // Başlık boyutu full viewport değil, başlangıç frame genişliğine göre
      const frameW = w * (Math.max(10, c.startWidth) / 100);
      stage.style.setProperty("--se-title-size", `${clamp(frameW * 0.09, 18, 40)}px`);
    };

...
const Beam = ({
  ...
  const background = color ? `linear-gradient(${color}, transparent)` : `linear-gradient(hsl(${hue} 80% 60%), transparent)`
...
export const WarpBackground = ({
  ...
  const generateBeams = useCallback(() => {
    ...
    const step = beamsPerSide > 0 ? cellsPerSide / beamsPerSide : 0
